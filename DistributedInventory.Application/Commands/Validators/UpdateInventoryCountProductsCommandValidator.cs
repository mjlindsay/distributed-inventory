...
{
    public class UpdateInventoryCountProductsCommandValidator : AbstractValidator<UpdateInventoryCountProductsCommand>
    {
        public UpdateInventoryCountProductsCommandValidator() {
